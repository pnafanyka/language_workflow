...
if __name__ == "__main__":
    obj = TextGrid.load('/Users/andrejpihtin/учеба/Науканский/file_ed/2021_07_02_Симон_наволок_Сестры_Воробьевы,_Галина_Ковалевич_и_Мария.TextGrid')
    print(type(obj))
    tiers = TextGrid._find_tiers(obj)

    for tier in tiers:
        print(Tier.transcript(tier))

    with open('out.txt', 'w') as f:
        with redirect_stdout(f):
            for tier in tiers:
                print(Tier.transcript(tier))
# saved results to out.txt